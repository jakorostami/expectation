...
class EfficiencyAnalyzer:
    ...
    def __init__(self, pre_dist: Optional[callable] = None, post_dist: Optional[callable] = None):
    ...
    def analyze_decay(self, e_values: ArrayLike, change_point: int) -> Tuple[float, float]:
    ...
    def compute_efficiency_metrics(
        self, detector: ConformalCUSUM, n_pre: int = 1000, n_post: int = 1000, n_trials: int = 100
    ) -> dict:
        detection_delays = []
        false_alarms = []
        decay_rates = []
