...
⚠️ **Pre-release Software Notice**: This library is currently in pre-release (v0.4.0). The repo may undergo significant changes before the 1.0.0 release. While the statistical implementations are sound, we recommend testing thoroughly before using in production environments.
